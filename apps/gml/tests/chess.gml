...
%%%
%%% Last change:
%%%   $Date: 2001/04/03 16:34:47 $ by $Author: fms $
%%%   $Revision: 1.2 $
%%%
...
{ /col2 /col1
  ...
  wedge 180.0 rotatey union wedge 240.0 rotatey union wedge 300.0 rotatey
union
...
0.33 0.33 0.33 point [ l ] scene 3 60.0 512 384  %% 1024 768 
"chess.ppm" render
