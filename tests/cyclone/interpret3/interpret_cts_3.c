...
void _Ginterpret_1_0_30();
void _Ginterpret_1_0_15();
void _Ginterpret_1_0_6();
...
/* JMP 22 */
extern void _Ginterpret_1_0_30/*50*/()
  {
    stack[1] = 3;
    stack[1] = mem[stack[1]];
    stack[2] = 0;
...
/* JMP 14 */
extern void _Ginterpret_1_0_15/*79*/()
  {
    stack[1] = 2;
    stack[1] = mem[stack[1]];
    stack[2] = 0;
 ...
 *
 */
extern void interpret_cts_3/*96*/()
  {
    stack[1] = 0;		/* start */
    stack[2] = 0;
    mem[stack[2]] = stack[1];
