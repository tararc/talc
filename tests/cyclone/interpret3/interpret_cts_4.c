...
/* JMP 48 */
extern void _Ginterpret_1_0_22/*88*/()
/* 
    ...
    if (! stack[1])
      {
        ...
        stack[2] = 3;
        mem[stack[2]] = stack[1];
        _Ginterpret_1_0_22/*1*/();
      }
    return;
  }

/* JMP 27 */
extern void _Ginterpret_1_0_14/*97*/()
/* 
binding times of written non_locals: mem D, stack D 
residual non-locals top: mem, stack 
eval non-locals top: inst.opcode, inst.val, prg_size 
 ...
 */
  {
    ...
    if (stack[1])
    ...
    else
      {
        ...
        stack[2] = 2;
        mem[stack[2]] = stack[1];
        _Ginterpret_1_0_14/*2*/();
      }
    return;
  }

/* JMP 6 */
extern void _Ginterpret_1_0_6b/*106*/()
/* 
binding times of written non_locals: mem D, stack D 
residual non-locals top: mem, stack 
eval non-locals top: inst.opcode, inst.val, prg_size 
 ...
 */
  {
    ...
    if (stack[1])
    ...
    else
      {
        ...
        stack[2] = 1;
        mem[stack[2]] = stack[1];
        _Ginterpret_1_0_6b/*107*/();
      }
    return;
  }

extern void interpret_cts_4()
/* 
binding times of written non_locals: mem D, stack D 
residual non-locals top: mem, stack 
eval non-locals top: inst.opcode, inst.val, prg_size 
